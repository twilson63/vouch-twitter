<script>
  ...
  const tweetHREF = (addr) => {
    const text = encodeURI(
      `I am vouching for my wallet address ${addr}  🐘 via @vouchdao!`
    );
  ...
  async function checkStatus() {
    if (current === "tweeted") {
      ...
      const result = await fetch("https://vouch-v0.hyper.io/vouch.json", {
        method: "POST",
  ...
  <div class="hero-content text-center">
    <div class="max-w-md">
      ...
      <div class="mt-32 flex justify-center space-x-4">
        <button on:click={getStarted} class="btn btn-primary"
          >Get Started</button
        >
        <a href="https://vouchdao.xyz" target="_blank" class="btn btn-secondary"
          >Learn More</a
        >
      </div>
    </div>
...
<div class="hero min-h-screen bg-primary">
  <div class="hero-content flex-col lg:flex-row">
    ...
    <div class="text-primary-content">
      ...
      <p class="py-6">
        You need to connect your Arweave Wallet. Choose the Wallet you use.
      </p>
      <div>
        <button
        ...
        <button
          disabled={current !== "welcome"}
          class="btn btn-secondary"
          on:click={appconnect}>Arweave.app</button
        >
      </div>
      <div class="mt-32 prose lg:prose-xl">
        <blockquote>
          Need a Wallet? You can install <a href="https://arconnect.io"
            >ArConnect</a
          >
          or
  ...
  <div class="hero min-h-screen bg-error">
    <div class="hero-content flex-col lg:flex-row">
      ...
      <div class="text-primary-content">
        ...
        <p class="py-6">
          Your wallet could not be verified using Vouch Twitter
        </p>
      </div>
    </div>
  </div>
  ...
  <div class="hero min-h-screen bg-secondary">
    <div class="hero-content flex-col lg:flex-row">
      ...
      <div class="text-primary-content">
        ...
        <p class="py-6">
          The Vouch Twitter service will process your request. It may take a few
          minutes for Vouch Twitter to confirm your tweet.
        </p>
